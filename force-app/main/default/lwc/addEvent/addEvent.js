...
import eName from '@salesforce/schema/Event__c.Name';
...
import Max_Seat__c from '@salesforce/schema/Event__c.Max_Seat__c';
...
export default class AddEvent extends NavigationMixin(LightningElement) {
    ...
    handleChange(event) {
        ...
        // MaxFIT Campaign
        // Name
        ///this.eventRecord[Name_F] = 'MaxFIT Campaign'
    }
    /*
    ...
    */
    ...
    handleClick() {
        const fields = {};
        fields[eName.fieldApiName] = this.eventRecord.eName;
        ...
        fields[Max_Seat__c.fieldApiName] = this.eventRecord.Max_Seat__c;
